...
class Timer(object):
    def __init__(self, description:str, logger:Logger, time_format:str='{:.3f} seconds', max_time:int=0) -> None:
...
def wait_until_queue_empty(queue:Union[Queue,MPQueue], timeout:float=5) -> None: ...
